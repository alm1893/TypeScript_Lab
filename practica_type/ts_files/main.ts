...
console.log("------------------Comienzo del programa con datos antiguos------------------");
...
console.log("------------------Datos nuevos persona con DNI incorrecto------------------");
...
console.log("------------------Datos nuevos persona con DNI correcto------------------");
agenda.cambiar("45783204M",dirN,mailN,tlfN);
agenda.show();
console.log("------------------Borramos persona B------------------");
agenda.delete(Pb);
agenda.show();
